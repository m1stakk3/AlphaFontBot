...
font3 = chr(9402) + chr(9447) + chr(9424) + chr(9436) + chr(9439) + chr(9435) + chr(9428)
font4 = chr(120020) + chr(120065) + chr(120042) + chr(120054) + chr(120057) + chr(120053) + chr(120046)
...
def on_start(message: types.Message):
        ...
        buttons = [font1, font2, font3, font4]
    ...
    if buts[2]:
        ...
        for i in range(len(got_text)):
            if ord(got_text[i]) in range(0, 123):
                ...
                if got_text[i].isupper() == True:
                    text_for_user += chr(9423 - (90 - ord(got_text[i])))
                else:
                    pass
            else:
                pass
        ...
        for i in range(len(got_text)):
            if ord(got_text[i]) in range(0, 123):
                if got_text[i] == ' ':
                    text_for_user += ' '
                if got_text[i].isupper() == True:
                    text_for_user += chr(120041 - (90 - ord(got_text[i])))
                if got_text[i].islower() == True:
                    text_for_user += chr(120068 - (123 - ord(got_text[i])))
                else:
                    pass
            else:
                pass
